...
export const mockRewards: Reward[] = [
  {
    ...
    bonuses: ['Доступ к шаблонам анализа аудитории', 'Сертификат эксперта', '+50 баллов рейтинга'],
  },
  {
    id: '2',
    ...
    bonuses: ['Canvas для создания УТП', 'Библиотека примеров', '+75 баллов рейтинга'],
  },
  {
    id: '3',
    name: 'Аналитик рынка',
    ...
    bonuses: ['Шаблоны SWOT и PEST анализа', 'Чек-лист аналитика', '+60 баллов рейтинга'],
  },
  {
    id: '4',
    ...
    bonuses: ['Excel-модели расчетов', 'Доступ к вебинарам по финансам', '+100 баллов рейтинга'],
  },
  {
    id: '5',
    ...
    bonuses: ['Чек-листы запуска MVP', 'Инструменты для тестирования', '+80 баллов рейтинга'],
  },
];
